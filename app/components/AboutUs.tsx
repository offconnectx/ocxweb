const AboutUs = () => {
  return (
    <section className="py-24 relative bg-gradient-to-b from-white to-blue-400 dark:from-[#244f6b] dark:to-[#356f91]">
      {/* 244f6b */}
...
<path className="stone_een" d="M30,16c0,3.279-2.631,5.939-5.896,5.995l-0.629-0.001C23.22,25.905,19.975,29,16,29
